 ...
 */
@Component
public class NaverProfileRequester implements SocialProfileRequester {
    ...
    public NaverProfileRequester(RestTemplate restTemplate, Gson gson, @Value("${value.social.naver.url.profile}") String profileUrl) {
