package petalk.mvp.auth.acceptance;
...
import petalk.mvp.auth.acceptance.apiTester.AuthenticateApiTester;
...
@DisplayName("구글 인증 요청 인수 테스트")
public class GoogleAuthenticateAcceptanceTest extends AbstractAcceptanceTest {
    ...
    void whenHaveSocialIdThenCanAuthenticate() {
        ...
        //when
        ExtractableResponse<Response> 인증_요청_응답 = apiTester.인증_요청("google", 소셜계정코드);
